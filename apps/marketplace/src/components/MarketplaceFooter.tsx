      ...
      <div className="mx-auto w-[min(100%-32px,1280px)] py-10">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <nav className="flex flex-wrap gap-x-8 gap-y-3 text-sm font-semibold">
            <Link href="/listings?purpose=sale" className="hover:text-white transition">Buy</Link>
            <Link href="/listings?purpose=rent_long" className="hover:text-white transition">Rent</Link>
